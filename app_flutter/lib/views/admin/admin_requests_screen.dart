                  ...
                  Row(
                    children: [
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Admin Panel', style: AppTextStyles.displaySmall),
                          Text('Workspace Requests', style: AppTextStyles.bodySmall),
                        ],
                      ),
                    ],
                  ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  _StatChip(label: 'Approved Today', value: '3', color: AppColors.riskLow),
                  const SizedBox(width: 10),
                  _StatChip(label: 'Total Clubs', value: '12', color: AppColors.accent),
                ],
              ),
                      ...
                      : RefreshIndicator(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (ctx, i) => _RequestCard(
                              ...
                              index: i,
                              onApprove: () => provider.approveWorkspace(provider.pendingRequests[i].id),
                            ),
                          ),
                        ),
            ),
...
class _RequestCard extends StatefulWidget {
  ...
  const _RequestCard({required this.request, required this.index, required this.onApprove});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: AppColors.riskMed.withOpacity(0.3)),
                ),
                child: Center(
                  child: Text(
                    req.clubName.substring(0, 2).toUpperCase(),
                    style: AppTextStyles.headlineSmall.copyWith(color: AppColors.riskMed),
                  ),
                ),
              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: AppColors.riskMed.withOpacity(0.12),
                  borderRadius: BorderRadius.circular(AppConstants.radiusCircle),
                  border: Border.all(color: AppColors.riskMed.withOpacity(0.3)),
                ),
                child: Text('PENDING', style: AppTextStyles.labelSmall.copyWith(color: AppColors.riskMed)),
              ),
            ],
          ),
          ...
          Row(
            children: [
              _DetailItem(icon: Icons.person_outline, label: 'Manager ID', value: req.managerId.substring(0, 12) + '...'),
              const SizedBox(width: 20),
              _DetailItem(icon: Icons.sports_soccer, label: 'Club ID', value: req.clubId),
            ],
          ),
            ...
            child: AnimatedContainer(
              ...
              child: Center(
                child: _approving
                    ? const SizedBox(
                        width: 18, height: 18,
                        child: CircularProgressIndicator(color: AppColors.riskLow, strokeWidth: 2),
                      )
                    : Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          const Icon(Icons.check_circle_outline, color: Colors.black, size: 16),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(label, style: AppTextStyles.caption),
                Text(value, style: AppTextStyles.bodySmall, overflow: TextOverflow.ellipsis),
              ],
            ),
          ),
        ],
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.inbox_rounded, color: AppColors.riskLow, size: 36),
          )
