  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 4),
        Text('Generated by Gemini AI · Evidence-backed',
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (driver.value.isNotEmpty) ...[
                        const SizedBox(height: 2),
                        Text(driver.value,
                            style: AppTextStyles.monoSmall
                                .copyWith(color: color)),
                      ],
                      if (driver.threshold.isNotEmpty)
      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            Text('Generating plan with Gemini AI...',
                style:
                    AppTextStyles.bodySmall.copyWith(color: AppColors.riskLow)),
            const SizedBox(height: 4),
            Text('Analyzing player data and building recommendations...',
                style: AppTextStyles.caption),
          ],
        ),
      );
