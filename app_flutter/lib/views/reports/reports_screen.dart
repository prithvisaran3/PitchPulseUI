            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Post-match readiness & load analysis',
                        ...
                        onTap: () => Navigator.push(
                          ...
                          PageRouteBuilder(
                            pageBuilder: (_, anim, __) =>
                                MatchDetailScreen(report: reports[i]),
...
class _ReportCard extends StatefulWidget {
  ...
  const _ReportCard(
      {required this.report, required this.index, required this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: AnimatedBuilder(
        animation: _ctrl,
        builder: (_, child) =>
            Transform.scale(scale: 1.0 - _ctrl.value * 0.02, child: child),
        child: Container(
            ...
            children: [
              ...
              if (r.avgPlayerLoad != null) ...[
                ...
                Row(children: [
                  _StatPill(
                      label: 'Avg Load',
                      value: '${r.avgPlayerLoad!.toInt()} AU',
